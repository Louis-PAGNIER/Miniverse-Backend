...
class Miniverse(Base):
    ...
    proxy = relationship("Proxy", back_populates="miniverses")

    user_roles = relationship("MiniverseUserRole", back_populates="miniverse", cascade="all, delete-orphan")
...
class MiniverseUserRole(Base):
    ...
    user = relationship("User", back_populates="miniverse_roles")
    miniverse = relationship("Miniverse", back_populates="user_roles")